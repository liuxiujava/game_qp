...
public abstract class StrMatcher {
    ...
    public static StrMatcher charSetMatcher(String chars) {
        return (StrMatcher)(chars != null && chars.length() != 0?(chars.length() == 1?new StrMatcher.CharMatcher(chars.charAt(0)):new StrMatcher.CharSetMatcher(chars.toCharArray())):NONE_MATCHER);
    }
