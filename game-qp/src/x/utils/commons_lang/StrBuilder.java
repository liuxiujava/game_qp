...
public class StrBuilder implements Cloneable {
    ...
    public StrBuilder appendNewLine() {
        if (this.newLine == null) {
            this.append((String) SystemUtils.LINE_SEPARATOR);
            return this;
        } else {
            return this.append((String) this.newLine);
        }
    }

    public StrBuilder appendNull() {
        return this.nullText == null ? this : this.append((String) this.nullText);
    }

    public StrBuilder append(Object obj) {
        return obj == null ? this.appendNull() : this.append((String) obj.toString());
    }
    ...
    public StrBuilder append(int value) {
        return this.append((String) String.valueOf(value));
    }
    ...
    public StrBuilder appendln(Object obj) {
        return this.append((Object) obj).appendNewLine();
    }

    public StrBuilder appendln(String str) {
        return this.append((String) str).appendNewLine();
    }

    public StrBuilder appendln(String str, int startIndex, int length) {
        return this.append((String) str, startIndex, length).appendNewLine();
    }

    public StrBuilder appendln(StringBuffer str) {
        return this.append((StringBuffer) str).appendNewLine();
    }

    public StrBuilder appendln(StringBuffer str, int startIndex, int length) {
        return this.append((StringBuffer) str, startIndex, length).appendNewLine();
    }

    public StrBuilder appendln(StrBuilder str) {
        return this.append((StrBuilder) str).appendNewLine();
    }

    public StrBuilder appendln(StrBuilder str, int startIndex, int length) {
        return this.append((StrBuilder) str, startIndex, length).appendNewLine();
    }

    public StrBuilder appendln(char[] chars) {
        return this.append((char[]) chars).appendNewLine();
    }

    public StrBuilder appendln(char[] chars, int startIndex, int length) {
        return this.append((char[]) chars, startIndex, length).appendNewLine();
    }
    ...
    public StrBuilder insert(int index, Object obj) {
        return obj == null ? this.insert(index, (String) this.nullText) : this.insert(index, (String) obj.toString());
    }
    ...
    public StrBuilder insert(int index, char[] chars) {
        this.validateIndex(index);
        if (chars == null) {
            return this.insert(index, (String) this.nullText);
        } else {
    ...
    public StrBuilder insert(int index, int value) {
        return this.insert(index, (String) String.valueOf(value));
    }
    ...
    public StrBuilder deleteAll(String str) {
        ...
        if (len > 0) {
            for (int index = this.indexOf((String) str, 0); index >= 0; index = this.indexOf((String) str, index)) {
    ...
    public StrBuilder replaceAll(String searchStr, String replaceStr) {
        ...
        if (searchLen > 0) {
            ...
            for (int index = this.indexOf((String) searchStr, 0); index >= 0; index = this.indexOf((String) searchStr, index + replaceLen)) {
    ...
    public int lastIndexOf(String str) {
        return this.lastIndexOf((String) str, this.size - 1);
    }
    ...
    public int lastIndexOf(StrMatcher matcher) {
        return this.lastIndexOf((StrMatcher) matcher, this.size);
    }
    ...
    public boolean equals(Object obj) {
        return obj instanceof StrBuilder ? this.equals((StrBuilder) ((StrBuilder) obj)) : false;
    }
    ...
    class StrBuilderWriter extends Writer {
        ...
        public void write(int c) {
            StrBuilder.this.append((char) ((char) c));
        }

        public void write(char[] cbuf) {
            StrBuilder.this.append((char[]) cbuf);
        }

        public void write(char[] cbuf, int off, int len) {
            StrBuilder.this.append((char[]) cbuf, off, len);
        }

        public void write(String str) {
            StrBuilder.this.append((String) str);
        }

        public void write(String str, int off, int len) {
            StrBuilder.this.append((String) str, off, len);
        }
    }
